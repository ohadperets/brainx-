...
const APP_DATA = {
  ...
  mathBigExam: {
    ...
    naturalNumbers: [
      ...
      { question: "מהו הערך של X: X + 15 = 32?", options: ["47", "17", "22", "12"], correct: 1, hint: "X = 32 - 15" },
      { question: "מהו הערך של X: X × 4 = 36?", options: ["9", "32", "40", "144"], correct: 0, hint: "X = 36 ÷ 4" },
      { question: "מהו הערך של X: 56 ÷ X = 8?", options: ["448", "7", "48", "64"], correct: 1, hint: "X = 56 ÷ 8" },
      { question: "מהו הערך של X: X - 28 = 45?", options: ["17", "73", "63", "83"], correct: 1, hint: "X = 45 + 28" },
      { question: "מהו הערך של X: 3 × X = 27?", options: ["30", "24", "9", "81"], correct: 2, hint: "X = 27 ÷ 3" },
